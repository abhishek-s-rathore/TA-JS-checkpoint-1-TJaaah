...
getOutput("Arya"); // "You are arya" ==>> Shown in console (locks value), "Who are you ?"==>> return from function (store value)
getOutput("John"); // "You are john" ==>> Shown in console (locks value), "Who are you ?"==>> return from function (store value)
getOutput(); //  "Who are you ?" ==>> return from function (store value)
```
